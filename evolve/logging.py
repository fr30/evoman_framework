...
def _draw_box_plots(directory1, directory2, enemies1, enemies2):
    ...
    data = pd.DataFrame({'Gain1': data_mean1['Gain'], 'Gain2': data_mean2['Gain'], 'Gain3': data_mean3['Gain'],
                         'Gain4': data_mean4['Gain']})
    print(data)
    # Set up box plot
    sns.set(rc={'figure.figsize': (9.6, 4.8)}, font_scale=2, style="whitegrid")
    palette = itertools.cycle(sns.color_palette("bright"))
    ...
    if not os.path.exists("optimization_generalist_plots"):
        os.mkdir("optimization_generalist_plots")
    plt.savefig(
        os.path.join("../optimization_generalist_plots", "box_plots_" + str(enemies1) + "_" + str(enemies2) + ".png"),
        dpi=300)
...
if __name__ == "__main__":
    _draw_line_plot("optimization_generalist_island", "optimization_generalist_pso", [7, 8])
    _draw_line_plot("optimization_generalist_island", "optimization_generalist_pso", [1, 5, 6])
    _draw_line_plot("optimization_generalist_island", "optimization_generalist_pso", [2, 5, 6])
    _draw_line_plot("optimization_generalist_island", "optimization_generalist_pso", [2, 4, 7, 8])
    _draw_line_plot("optimization_generalist_island", "optimization_generalist_pso", [2, 3, 5, 8])

    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [7, 8], [1, 5, 6])
    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [7, 8], [2, 5, 6])
    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [7, 8], [2, 4, 7, 8])
    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [7, 8], [2, 3, 5, 8])

    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [1, 5, 6], [2, 5, 6])
    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [1, 5, 6], [2, 4, 7, 8])
    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [1, 5, 6], [2, 3, 5, 8])

    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [2, 5, 6], [2, 4, 7, 8])
    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [2, 5, 6], [2, 3, 5, 8])

    _draw_box_plots("optimization_generalist_island", "optimization_generalist_pso", [2, 4, 7, 8], [2, 3, 5, 8])
